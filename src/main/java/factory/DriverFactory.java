...
public class DriverFactory {
	 ...
	 * + "/src/test/resources/Download/chromedriver"); //
	 ...
	 * resource // options.addArguments("--remote-debugging-port=38500"); // # this
	 * //options.addArguments("--whitelisted-ips");
	 * 
	 * // driver = new RemoteWebDriver(capabilities); // Capabilities
